    ...
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {[
            { icon: <FaFacebook />, link: "https://www.facebook.com/share/1CVsk4KSqE/" },
            { icon: <FaLinkedin />, link: "https://www.linkedin.com/in/anshu-kumar-473527307" },
            { icon: <FaInstagram />, link: "https://www.instagram.com/light__bugs/" },
            { icon: <FaGithub />, link: "https://github.com/Anshu010412" },
